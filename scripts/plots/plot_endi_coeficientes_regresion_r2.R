# ============================================================
# plot_endi_coeficientes_regresion_r2.R
# Visualización de los coeficientes del modelo parsimonioso
# sobre el desarrollo del vocabulario infantil (ENDI Ronda 2)
# Requiere: data/processed/coeficientes_modelo_r2.rds
# Guarda:   outputs/figures/impacto_vocabulario_coeficientes_r2.png
# ============================================================
...
input_path <- "data/processed/coeficientes_modelo_r2.rds"
out_path <- "outputs/figures/impacto_vocabulario_coeficientes_r2.png"
