# ============================================================
# plot_endi_educacion_madre_r2.R
# Distribución del puntaje de vocabulario (Z-Score) según el
# nivel de instrucción de la madre (ENDI Ronda 2)
# Requiere: data/processed/endi_vocabulario_muestra_r2.rds
# Guarda:   outputs/figures/distribucion_vocabulario_educacion_madre_r2.png
# ============================================================
...
out_path <- "outputs/figures/distribucion_vocabulario_educacion_madre_r2.png"
