# ============================================================
# plot_endi_trayectorias_aprendizaje_r2.R
# Trayectorias de aprendizaje del vocabulario (LOESS)
# según el quintil de riqueza del hogar (ENDI Ronda 2)
# Requiere: data/processed/endi_vocabulario_muestra_r2.rds
# Guarda:   outputs/figures/trayectorias_vocabulario_quintiles_r2.png
# ============================================================
...
input_path <- "data/processed/endi_vocabulario_muestra_r2.rds"
out_path <- "outputs/figures/trayectorias_vocabulario_quintiles_r2.png"
...
caption_raw <- paste0(
  "Fuente: Encuesta Nacional de Desnutrición Infantil (Ronda 2), INEC. ",
